...
def print_grid(max_x, max_y, head_position, tail_position)
  max_y.times do |_y|
    max_x.times do |x|
      y = max_y - 1 - _y
      coord = [x, y]

      if head_position == coord
        print("H ")
      elsif tail_position == coord
        print("T ")
      else
        print(". ")
      end
...
# print_grid(6, 5, head_position, tail_position)
# puts()
